        ...
        <form wire:submit.prevent="save" class="mt-6 space-y-6">
            ...
            <div class="p-4 sm:p-8 bg-white dark:bg-gray-800 shadow sm:rounded-lg">
                ...
                <div class="max-w-xl">
                    ...
                    <x-text-input placeholder="Szerver címe" wire:model.live="mail_host" id="mail_host" name="mail_host"
                        type="text" class="mt-1 block w-full" />
                    @error('mail_host')
                        <x-input-error :messages="$message" class="mt-2" />
                    @enderror
                    ...
                    <x-text-input placeholder="465" wire:model.live="mail_port" id="mail_port" name="mail_port"
                    ...
                    <x-text-input placeholder="Email cím" wire:model.live="mail_username" id="mail_username"
                        name="mail_username" type="email" class="mt-1 block w-full" />
                    @error('mail_username')
                        <x-input-error :messages="$message" class="mt-2" />
                    @enderror

                    <x-input-label for="mail_password" :value="__('Jelszó')" />
                    <x-text-input placeholder="Jelszó" wire:model.live="mail_password" id="mail_password"
                        name="mail_password" type="password" class="mt-1 block w-full" />
                    @error('mail_password')
                        <x-input-error :messages="$message" class="mt-2" />
                    @enderror
            ...
            <div class="p-4 sm:p-8 bg-white dark:bg-gray-800 shadow sm:rounded-lg">
                <div class="max-w-xl">
                    ...
                    <x-text-input placeholder="Jelszó" wire:model.live="db_password" id="db_password"
                        name="db_password" type="password" class="mt-1 block w-full" />
                    @error('db_password')
                        <x-input-error :messages="$message" class="mt-2" />
                    @enderror
            ...
            @if (!config('app.installed'))
                ...
                <div class="p-4 sm:p-8 bg-white dark:bg-gray-800 shadow sm:rounded-lg">
                    <div class="max-w-xl">
                        ...
                        <x-text-input placeholder="Név" wire:model.live="admin_name" id="admin_name"
                            name="admin_name" type="text" class="mt-1 block w-full" />
                        @error('admin_name')
                            <x-input-error :messages="$message" class="mt-2" />
                        @enderror

                        <x-input-label for="admin_username" :value="__('Felhasználónév')" />
                        <x-text-input placeholder="Felhasználónév" wire:model.live="admin_username"
                            id="admin_username" name="admin_username" type="text" class="mt-1 block w-full" />
