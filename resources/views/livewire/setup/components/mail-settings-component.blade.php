<div class="max-w-xl mb-6 p-4 sm:p-8 bg-white dark:bg-gray-800 shadow sm:rounded-lg basis-1/2">
    ...
    <div class="flex items-center gap-4">
        <x-primary-button wire:loading.remove wire:click.prevent="save_mail">{{ __('Mentés') }}</x-primary-button>

        <x-action-message wire:loading class="me-3 pt-3" on="save_mail">
            <x-loading />
        </x-action-message>
